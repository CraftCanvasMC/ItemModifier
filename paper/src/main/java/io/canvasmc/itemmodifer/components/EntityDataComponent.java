...
public class EntityDataComponent extends ComponentType<TypedEntityData<EntityType<?>>> {
    @Override
    ...
    @Override
    public TypedEntityData<EntityType<?>> parse(@NonNull final String raw) throws CommandSyntaxException {
        try {
    ...
    @Override
    public DataComponentType<TypedEntityData<EntityType<?>>> nms() {
        return DataComponents.ENTITY_DATA;
    }
}
